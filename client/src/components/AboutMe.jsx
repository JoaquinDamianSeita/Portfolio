...
function AboutMe() {
  return (
    <div className="container sky col-xl-10 col-xxl-8 px-4 py-5" id="sobremi">
      <div className="row align-items-center g-lg-5 py-5">
        <div className="col-lg-7 text-center text-lg-start">
          <h1 className="display-3 fw-bold mb-3 title-cv">¿Quién soy?</h1>

          <p className="col-lg-10 fs-4">
            Soy un desarrollador web en busqueda de aprender nuevas tecnologías,
          ...
          <button className="btn btn-lg btn-cv">
            <b>Descargar CV</b>
          </button>
        </div>
